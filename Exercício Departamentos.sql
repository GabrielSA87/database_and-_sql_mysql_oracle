...
O gestor de marketing pediu a lista das funcionárias que trabalham no departamento de filmes 
...
/* Para : Traga os funcionários que trabalham no departamento de filmes OU 
...
/* Para : O gestor de marketing pediu a lista das funcionárias que trabalham 
no departamento de filmes ou no departamento lar. Ele necessita enviar um email 
...
WHERE (Departamento = 'Filmes' OR Departamento = 'Lar')
AND (Sexo = 'Feminino') GROUP BY Departamento;

/* -------------------------------------------------------------------------------- */

/* Para : Traga os funcionários do sexo masculino ou os funcionários que 
trabalham no setor Jardim. */
...
SELECT Sexo, Departamento, COUNT(*) FROM funcionarios
WHERE (Sexo = 'Masculino' OR Departamento = 'Jardim')
GROUP BY Sexo;
